import { Meal, Drink, AAAAAAAAA } from './types';
...
export async function searchDrinksByIngredient(ingredient: string): Promise<AAAAAAAAA[]> {
...
export async function searchDrinksByName(name: string): Promise<AAAAAAAAA[]> {
...
export async function searchDrinksByFirstLetter(letter: string): Promise<AAAAAAAAA[]> {
